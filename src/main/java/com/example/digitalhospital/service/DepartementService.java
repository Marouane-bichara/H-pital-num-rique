...
import com.example.digitalhospital.service.interfacesService.IDepartementService;
...
public class DepartementService  implements IDepartementService {
    ...
    public Departement getDepartementWithDocteurs(Long id) {
        Departement departement = departementRepository.getByIdWithDocteurs(id);
        if (departement == null) {
    ...
    public Departement updateDepartement(Long id, String nom) {
        Departement existingDept = departementRepository.findById(id);
        ...
        Departement departement = existingDept;
